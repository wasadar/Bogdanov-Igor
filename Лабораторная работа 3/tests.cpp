...
int main() {
	...
	test_dir.read_from_file("data.txt");
	test_dir.print_all();
	std::cout << "Если перед этим сообщение на экран вывелась информация о всех предыдущих файлах и одном новом, то метод записи информации в файл работает правильно." << "\n";
