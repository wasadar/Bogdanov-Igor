...
system_file::system_file(x_version* x, const size_t_t& sz, const size_t_t& ind, const bool& sys, const bool& hid, const std::string& nm , const bool& exe) : file(x, sz, ind, sys, hid, nm), is_executable(exe) { }
