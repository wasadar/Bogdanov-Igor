...
int main() {
	...
	x32->change_ver(32);
	x64->change_ver(64);
	file test_file_1(x32, 1, 1, true, true, "ABC");
	file test_file_2(x64, 2, 2, false, false, "BCD");
	std::cout << "“ест будет пройден если сейчас на экран будет выведена следующа€ последовательность: 1 1 0 0 0 - ";
